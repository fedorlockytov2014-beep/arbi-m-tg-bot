...
class OrderId(BaseModel):
    """
    Value object для идентификатора заказа.
    
    Attributes:
        value: Значение идентификатора заказа (UUID в виде строки)
    """
    ...
    @classmethod
    def from_uuid(cls, uuid_value: Union[UUID, str]) -> 'OrderId':
        """
        Создаёт объект OrderId из UUID или строки.
        
        Args:
            uuid_value: UUID или строка
            
        Returns:
            OrderId: Новый объект OrderId
        """
